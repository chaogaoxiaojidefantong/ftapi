...
function calcTextareaHeight(uiTextNode) {
  let minRows = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  let maxRows = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  let useCache = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  let {
    ...
    boxSizing,
    sizingStyle
  } = calculateNodeStyling(uiTextNode, useCache); // Need to have the overflow attribute to hide the scrollbar otherwise
